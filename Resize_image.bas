Sub WIA_Resize_Image()
    ...
    'Apply filter
    WIA_ImgP.Filters.Add WIA_ImgP.FilterInfos("Scale").FilterID

    'Change de dimensions to 100 x 100
    WIA_ImgP.Filters(1).Properties("MaximumWidth") = 100
    WIA_ImgP.Filters(1).Properties("MaximumHeight") = 100
    WIA_ImgP.Filters(1).Properties("PreserveAspectRatio") = True
